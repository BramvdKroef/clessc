...
.class { \
  ...
  less->process(*css, context);
  css->write(*writer);
  ASSERT_STREQ(".class{color:#ed2c2c;color:#a50e0e;color:#e00606;color:#c91e1e;color:#d41212;color:rgba(212, 18, 18, 0.9);color:#d43212;color:#d41232;color:#f1dada;clip:rect(1px, 1px, 1px, 1px)}", out->str().c_str());
} 
